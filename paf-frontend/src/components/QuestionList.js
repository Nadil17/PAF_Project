...
function QuestionList() {
    ...
    //     console.log("Edit Question:", questionId);
        ...
        const handleEditQuestion = (e, questionId) => {
            e.stopPropagation(); // Prevent click from affecting the question
            navigate(`/edit-question/${questionId}`);
            alert(`Edit question ${questionId} - TODO: Implement`);
        };
    ...
    if (loading) {
        return <div className="text-center py-10 text-emerald-800 font-semibold">Loading questions...</div>;
    }

    if (error) {
        return <div className="text-center py-10 text-red-700 font-semibold">{error}</div>;
    }
        ...
        <div className="max-w-4xl mx-auto p-5 bg-emerald-50 min-h-screen font-['Montserrat',_sans-serif]">
            ...
            <div className="mb-8 text-center bg-gradient-to-r from-green-800 to-emerald-600 py-6 rounded-lg shadow-lg">
                <div className="flex items-center justify-center mb-2">
                    ...
                    <h1 className="text-3xl font-bold text-white">Farm Q&A Forum</h1>
                </div>
