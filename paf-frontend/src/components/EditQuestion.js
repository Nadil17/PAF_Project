    ...
    return (
      <div className="bg-emerald-50 min-h-screen font-['Montserrat',_sans-serif]">
        ...
        <div className="max-w-4xl mx-auto p-5">
          ...
          <div className="text-center py-10 text-red-700 font-semibold bg-red-50 rounded-lg border border-red-200 shadow-md">
            {error}
          </div>
        </div>
      </div>
  ...
  return (
    <div className="bg-emerald-50 min-h-screen font-['Montserrat',_sans-serif]">
      ...
      <div className="max-w-4xl mx-auto p-5">
        ...
        {error && (
          <div className="bg-red-50 text-red-700 p-4 mb-6 rounded-lg border-l-4 border-red-700 shadow-md">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg p-6 shadow-lg">
          <div className="mb-6">
            ...
            <input
              ...
              required
              className="w-full p-4 border border-emerald-300 rounded-lg text-base font-normal focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 shadow-sm"
            />
          </div>
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              rows="10"
              required
              className="w-full p-4 border border-emerald-300 rounded-lg text-base font-normal resize-y min-h-40 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 shadow-sm"
            />
          </div>
          ...
          <div className="flex justify-between items-center mt-6">
            <button
              type="button"
              className="px-5 py-2.5 bg-black text-white rounded-md font-medium hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-2 shadow-sm transition-colors duration-200 min-w-[100px]"
            ...
            <button 
              type="submit" 
              className="px-5 py-2.5 bg-black text-white rounded-md font-medium hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-2 shadow-md transition-colors duration-200 min-w-[150px]"
            >
              Update Question
            </button>
          </div>
